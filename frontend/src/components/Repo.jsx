...
const Repo = ({repo}) => {
	...
	let imgsrc = "/javascript.svg"; // Use let instead of const for mutable assignment


	if (language && langs.hasOwnProperty(language)) {
   		 imgsrc = langs[language]; // Assign to imgsrc using let
	}
	return (
		<li className='mb-10 ms-7'>
			...
			<p className='mb-4 text-base font-normal text-gray-500'>{repo?.description}</p>
			<img src={imgsrc} alt='Programming language icon' className='h-8' />
		</li>
	);
};
